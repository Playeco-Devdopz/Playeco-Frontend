...
const Superchat = ({ onClose }: { onClose: () => void }) => {

    const qrCodeValue = '73084284242'
            ...
            <div
                ...
                <div className="bg-white w-[400px] flex flex-col items-center justify-center p-6 rounded-lg  shadow-lg">
                    <div className='flex flex-row items-center justify-between w-[100%]'>
                        <h2 className="text-lg text-black font-semibold mb-4">Superchat <span className="text-sm"><br />(Scan & Pay)</span></h2>
